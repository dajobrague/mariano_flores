  ...
  return (
    <footer className="text-white" style={{backgroundColor: '#2e7d32'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold">Mariano Flores Rubio</h3>
                <p className="text-green-200 text-sm">Excelencia Dental</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-green-100 text-sm">(+51) 913 080 814</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-green-100 text-sm">contact@marianofloresrubio.com</span>
              </div>

              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-green-300 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-green-100 text-sm">Manuel Olguin 555, Surco, Lima</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2 mb-6">
              ...
              <Link href="/staff" className="text-green-200 hover:text-white transition-colors text-sm">
                Personal
              </Link>
              <Link href="/services" className="text-green-200 hover:text-white transition-colors text-sm">
                Servicios
              </Link>
              <Link href="/testimonials" className="text-green-200 hover:text-white transition-colors text-sm">
                Testimonios
              </Link>
            </div>
            ...
            {/* Social Links */}
            <div className="flex items-center gap-3">
              <a href="#" className="text-green-300 hover:text-white transition-colors" aria-label="Facebook">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V7.548c0-.926.258-1.56 1.587-1.56h1.684V3.127A22.336 22.336 0 0014.201 3c-2.444 0-4.122 1.492-4.122 4.231v2.355H7.332v3.209h2.753v8.202h3.312z"/>
                </svg>
              </a>
              <a href="#" className="text-green-300 hover:text-white transition-colors" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bottom Section */}
        <div className="border-t mt-8 pt-6" style={{borderColor: '#1b5e20'}}>
